...
Route::get('/galeri/tambah',[GaleriController::class,'tambah'])->name('tambahGaleri')->middleware('auth');
Route::post('/galeri/tambah',[GaleriController::class,'tambahProses'])->name('tambahGaleriProses')->middleware('auth');
Route::get('/galeri/hapus',[GaleriController::class,'hapus'])->name('hapusGaleri')->middleware('auth');
Route::get('/galeri/detail/{id}',[GaleriController::class,'detail'])->name('detailGaleri')->middleware('auth');
Route::get('/galeri/detail/tambah/{id}',[GaleriController::class,'tambahDetail'])->name('tambahDetailGambar')->middleware('auth');
Route::get('/galeri/detail/hapus/{id}',[GaleriController::class,'hapusDetail'])->name('hapusDetailGaleri')->middleware('auth');
Route::post('/galeri/detail/tambah/{id}',[GaleriController::class,'tambahDetailProses'])->name('tambahDetailProses')->middleware('auth');
