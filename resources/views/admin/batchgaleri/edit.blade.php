            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <h2 class="admin-page-title">
                        ...
                        <span>Edit Nama Album</span>
                    </h2>
                    <p class="admin-page-subtitle">Perbarui judul atau label folder album foto galeri desa</p>
                </div>
            </div>
            ...
            <div class="admin-card">
                <div class="admin-card-header">
                    <h5 class="admin-card-title">
                        ...
                        <span>Formulir Perubahan Album</span>
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('batchgaleri.update', $batch->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama" id="nama"
                                    ...
                                    value="{{ old('nama', $batch->nama) }}" required>
                                @error('nama')
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-2 pt-3 border-top">
                            ...
                            <button type="submit" class="btn-admin-primary">
                                <i class="fas fa-save"></i> Perbarui Album
                            </button>
                        </div>
                    </form>
                </div>
