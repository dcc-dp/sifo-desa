                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="mb-4 bg-light p-3 rounded-3 border">
                            ...
                            <input type="text" class="form-control bg-white @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Contoh: Pengelola Berita">
                            @error('name')
                                                    ...
                                                    @foreach($menuItems as $item)
                                                        ...
                                                        <tr class="menu-row" data-title="{{ strtolower($item->title) }}" data-cat="{{ $catSlug }}">
                                                            ...
                                                            <td class="text-center">
                                                                @if($viewPerm)
                                                                    <label class="perm-badge-label">
                                                                        <input class="perm-check-input cat-perm-{{ $catSlug }}" type="checkbox" name="permissions[]" value="{{ $viewPerm->name }}">
                                                            ...
                                                            <td class="text-center">
                                                                @if($createPerm)
                                                                    <label class="perm-badge-label">
                                                                        <input class="perm-check-input cat-perm-{{ $catSlug }}" type="checkbox" name="permissions[]" value="{{ $createPerm->name }}">
                                                            ...
                                                            <td class="text-center">
                                                                @if($editPerm)
                                                                    <label class="perm-badge-label">
                                                                        <input class="perm-check-input cat-perm-{{ $catSlug }}" type="checkbox" name="permissions[]" value="{{ $editPerm->name }}">
                                                            ...
                                                            <td class="text-center">
                                                                @if($deletePerm)
                                                                    <label class="perm-badge-label">
                                                                        <input class="perm-check-input cat-perm-{{ $catSlug }}" type="checkbox" name="permissions[]" value="{{ $deletePerm->name }}">
