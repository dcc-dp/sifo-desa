        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Formulir untuk menambah menu baru</p>
                </div>
                <div>
                    ...
                    <form action="{{ route('admin.menus.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Contoh: Manajemen User" required>
                                @error('title') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-12 mb-4">
                                <label for="icon" class="form-label fw-bold">Ikon (SVG Code atau Kosongkan)</label>
                                <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ old('icon') }}" placeholder='<svg xmlns="http://www.w3.org/2000/svg"...'>
                                @error('icon') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-12 mb-4">
                                <label for="route_name" class="form-label fw-bold">Route Name (opsional)</label>
                                <input type="text" class="form-control @error('route_name') is-invalid @enderror" id="route_name" name="route_name" value="{{ old('route_name') }}" placeholder="admin.menus.index">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="url" name="url" value="{{ old('url') }}" placeholder="/admin/dashboard">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="number" class="form-control @error('order_num') is-invalid @enderror" id="order_num" name="order_num" value="{{ old('order_num', 0) }}" required>
                        ...
                        <div class="row bg-light rounded p-3 mb-4 mt-2 mx-1 border">
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" id="is_header" name="is_header" value="1" {{ old('is_header') ? 'checked' : '' }}>
                                    ...
                                    @foreach($roles as $role)
                                        <div class="col-md-3 mb-2">
                                            <div class="form-check custom-checkbox">
                                                ...
                                                {{ (is_array(old('roles')) && in_array($role->id, old('roles'))) || $role->name === 'Super Admin' ? 'checked' : '' }}>
