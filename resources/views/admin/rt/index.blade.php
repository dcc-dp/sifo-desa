                            ...
                            <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                                <div class="ms-auto d-flex">
                                    <button type="button"
                                        ...
                                        <a href="{{ route('rt-create') }}" class="btn-primary">Tambah Data
                                            Penduduk</a>
                                    </button>
                                </div>
                                ...
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th style="background-color:#313d52ff;" class="text-white">Nomor RT</th>
                                        ...
                                        @foreach ($data as $index => $rt)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <form action="{{ route('rt-destroy', $rt->id) }}"
