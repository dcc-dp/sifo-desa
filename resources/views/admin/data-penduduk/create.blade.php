        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Input data kependudukan warga baru ke dalam database desa</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('data.penduduk-store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nik" id="nik" value="{{ old('nik') }}"
                                    class="form-control font-monospace @error('nik') is-invalid @enderror"
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tempat_lahir" id="tempat_lahir"
                                    value="{{ old('tempat_lahir') }}" class="form-control @error('tempat_lahir') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                                    value="{{ old('tanggal_lahir') }}" class="form-control @error('tanggal_lahir') is-invalid @enderror" required>
                                @error('tanggal_lahir')
                                    <span class="text-danger text-xs mt-1 d-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" id="alamat" rows="2" class="form-control @error('alamat') is-invalid @enderror"
                                placeholder="Alamat jalan, nomor rumah, atau nama dusun..." required>{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <span class="text-danger text-xs mt-1 d-block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="keldesa" id="keldesa"
                                    value="{{ old('keldesa', 'Rante Gola') }}" class="form-control @error('keldesa') is-invalid @enderror" required>
                                @error('keldesa')
                                    <span class="text-danger text-xs mt-1 d-block">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kecamatan" id="kecamatan"
                                    value="{{ old('kecamatan') }}" class="form-control @error('kecamatan') is-invalid @enderror" required>
                                @error('kecamatan')
                                    <span class="text-danger text-xs mt-1 d-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="status_perkawinan" id="status_perkawinan"
                                    value="{{ old('status_perkawinan') }}" class="form-control @error('status_perkawinan') is-invalid @enderror"
                                    placeholder="Belum Kawin / Kawin / Cerai..." required>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kewarganegaraan" id="kewarganegaraan"
                                    value="{{ old('kewarganegaraan', 'WNI') }}" class="form-control @error('kewarganegaraan') is-invalid @enderror" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="pendidikan" id="pendidikan" class="form-select @error('pendidikan') is-invalid @enderror" required>
                                    ...
                                    <option value="D3" {{ old('pendidikan') == 'D3' ? 'selected' : '' }}>Diploma (D3)</option>
