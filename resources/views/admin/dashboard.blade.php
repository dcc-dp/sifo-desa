                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class="w-100">
                                        ...
                                        <h2 class="mb-0 fw-bold">{{$pendudukCount}}</h2>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h2 class="mb-0 fw-bold">{{$beritaCount}}</h2>
                                        <!-- <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h2 class="mb-0 fw-bold">{{$pengaduanCount}}</h2>
                                        <!-- <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h2 class="mb-0 fw-bold">{{$pemerintahanCount}}</h2>
                                        <!-- <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
