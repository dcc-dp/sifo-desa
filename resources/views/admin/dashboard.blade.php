                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Total Penduduk</p>
                                        <h4 class="mb-2 font-weight-bold">{{$pendudukCount}}</h4>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Total Berita</p>
                                        <h4 class="mb-2 font-weight-bold">{{$beritaCount}}</h4>
                                        <!-- <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Total Pengaduan</p>
                                        <h4 class="mb-2 font-weight-bold">{{$pengaduanCount}}</h4>
                                        <!-- <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Total Pemerintah</p>
                                        <h4 class="mb-2 font-weight-bold">{{$pemerintahanCount}}</h4>
                                        <!-- <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
