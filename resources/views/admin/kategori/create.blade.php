        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Buat kategori baru untuk mengelompokkan artikel dan berita desa</p>
                </div>
            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_kategori" id="nama_kategori"
                                       ...
                                       placeholder="Contoh: Pengumuman, Pembangunan, Kegiatan Warga..." required>
                                @error('nama_kategori')
