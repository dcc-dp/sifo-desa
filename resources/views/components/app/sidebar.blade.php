        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Manajemen Profil Desa</span>
                </div>
            </li>
                ...
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            ...
                            <title>datapenduduk</title>
                            <g id="datapenduduk" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>datapenduduk</title>
                            <g id="datapenduduk" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                    ...
                    <span class="nav-link-text ms-1">Pemerintah Desa</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Manajemen Agenda</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            ...
                            <g id="kat_berita" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                                        d="M0,1.71428571 C0,0.76752 0.76752,0 1.71428571,0 L22.2857143,0 C23.2325143,0 24,0.76752 24,1.71428571 L24,5.14285714 C24,6.08962286 23.2325143,6.85714286 22.2857143,6.85714286 L1.71428571,6.85714286 C0.76752,6.85714286 0,6.08962286 0,5.14285714 L0,1.71428571 Z"
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>agendakegiatan</title>
                            <g id="agen_kegiatan" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Manajemen Persuratan</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>suratdomisi</title>
                            <g id="surat_dom" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                                        d="M0,1.71428571 C0,0.76752 0.76752,0 1.71428571,0 L22.2857143,0 C23.2325143,0 24,0.76752 24,1.71428571 L24,5.14285714 C24,6.08962286 23.2325143,6.85714286 22.2857143,6.85714286 L1.71428571,6.85714286 C0.76752,6.85714286 0,6.08962286 0,5.14285714 L0,1.71428571 Z"
                    ...
                    <span class="nav-link-text ms-1">Surat Domisili</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>suratpengantar</title>
                            <g id="surat_peng" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                                        d="M0,1.71428571 C0,0.76752 0.76752,0 1.71428571,0 L22.2857143,0 C23.2325143,0 24,0.76752 24,1.71428571 L24,5.14285714 C24,6.08962286 23.2325143,6.85714286 22.2857143,6.85714286 L1.71428571,6.85714286 C0.76752,6.85714286 0,6.08962286 0,5.14285714 L0,1.71428571 Z"
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>suratketusaha</title>
                            <g id="surat_ketusaha" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                    ...
                    <span class="nav-link-text ms-1">Surat Keterangan Usaha</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>suratizinkeramaian</title>
                            <g id="surat_izinker" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                    ...
                    <span class="nav-link-text ms-1">Surat Izin Keramaian</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>SKTM</title>
                            <g id="sktm" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                                        d="M0,1.71428571 C0,0.76752 0.76752,0 1.71428571,0 L22.2857143,0 C23.2325143,0 24,0.76752 24,1.71428571 L24,5.14285714 C24,6.08962286 23.2325143,6.85714286 22.2857143,6.85714286 L1.71428571,6.85714286 C0.76752,6.85714286 0,6.08962286 0,5.14285714 L0,1.71428571 Z"
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Manajemen Pengaduan</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>riwayatpengaduan</title>
                            <g id="riw_pengaduan" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
                                <g id="template" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
