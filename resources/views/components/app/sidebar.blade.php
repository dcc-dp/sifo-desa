...
@endphp
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link  {{ request()->routeIs('admin.pengajuan-surat.*') ? 'active' : '' }}"
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('admin.user-index') ? 'active' : '' }}"
