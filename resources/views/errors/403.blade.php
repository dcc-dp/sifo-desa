...
<head>
    ...
    <title>403 - Akses Ditolak | SIFO DESA</title>
...
<body>
    <div class="error-card">
        ...
        <h1 class="error-title">Akses Halaman Ditolak</h1>
        <p class="error-desc">
            Maaf, akun Anda saat ini tidak memiliki izin (*hak akses*) untuk membuka atau mengelola halaman ini.
        </p>
